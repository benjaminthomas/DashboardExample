...
export default function Card({ title, status }: CardProps) {
  ...
  return (
    <>
      <div className="relative border-b border-r border-stroke dark:border-strokedark xl:border-b-0">
          ...
          <div className="flex items-stretch gap-5.5">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-0">
                <span
                  className={`font-medium text-gray-500 dark:text-gray-400 ${status.textColor}`}
                >
      ...
      {/* Render the Modal component only if isModalOpen is true */}
      {isModalOpen && (
        <Modal
